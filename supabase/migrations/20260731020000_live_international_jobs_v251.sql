...
values
  (
    ...
    'official_public_listing',true,'approved','AU','Attribute Queensland Health SmartJobs and retain the original vacancy URL.',
  ...
  (
    ...
    'official_public_listing',true,'approved','NZ','Attribute New Zealand Government Jobs and retain the original vacancy URL.',
  ...
  (
    ...
    'official_public_listing',true,'approved','CA','Attribute Government of Canada Job Bank and retain the original vacancy URL.',
  ...
  (
    ...
    'official_public_listing',true,'approved','IE','Attribute Ireland Health Service Executive and retain the original vacancy URL.',
  ...
  (
    ...
    'official_public_listing',true,'approved','AE','Attribute Emirates Health Services and retain its official careers route.',
  ...
  (
    ...
    'official_public_listing',true,'approved','SA','Attribute King Faisal Specialist Hospital & Research Centre and retain the official vacancy URL.',
