(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v53.js?v=53').catch(error=>console.warn('Offline support:',error.message)),{once:true});
