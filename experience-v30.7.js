(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v63.js?v=63').catch(error=>console.warn('Offline support:',error.message)),{once:true});
