(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v58.js?v=58').catch(error=>console.warn('Offline support:',error.message)),{once:true});
