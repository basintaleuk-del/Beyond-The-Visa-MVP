(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v55.js?v=55').catch(error=>console.warn('Offline support:',error.message)),{once:true});
