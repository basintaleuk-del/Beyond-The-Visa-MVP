(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v54.js?v=54').catch(error=>console.warn('Offline support:',error.message)),{once:true});
