(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v57.js?v=57').catch(error=>console.warn('Offline support:',error.message)),{once:true});
