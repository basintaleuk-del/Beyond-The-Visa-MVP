(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=48').catch(error=>console.warn('Offline support:',error.message)),{once:true});
