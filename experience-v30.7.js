(()=>{
 ...
 if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('./sw-v60.js?v=60').catch(error=>console.warn('Offline support:',error.message)),{once:true});
