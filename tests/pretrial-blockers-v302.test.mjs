...
test('signed-out auth renders before authenticated assets and videos do not preload', () => {
  ...
  assert.ok(html.indexOf('social-auth-v69.js?v=302') < html.indexOf('storage-v21.js'));
  assert.equal((html.match(/auth-redesign-v69\.css\?v=302/g) || []).length, 1);
  assert.equal((html.match(/social-auth-v69\.js\?v=302/g) || []).length, 1);
