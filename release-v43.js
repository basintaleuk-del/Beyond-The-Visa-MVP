(()=>{
 ...
 function installBrand(){
  ...
  if(!brand.querySelector('.btvAdaptiveBrand'))brand.innerHTML='<img class="btvAdaptiveBrand" src="assets/btv-brand-adaptive.png?v=43" alt="Beyond The Visa — Guidance, Preparation, Your Future">';
