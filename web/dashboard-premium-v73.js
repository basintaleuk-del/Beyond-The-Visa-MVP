  ...
  const socialLinksMarkup = () => `
    <nav class="sidebarSocialStrip262" aria-label="Connect with Beyond the Visa">
      ...
      <a class="isInstagram262" href="https://www.instagram.com/beyondthevisa_official?igsh=eTlraTNjdnNpdWwy&amp;utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Visit Beyond the Visa on Instagram" title="Instagram @beyondthevisa_official">
        <svg viewBox="0 0 24 24" aria-hidden="true" fill="none"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4.1"/><circle cx="17.6" cy="6.5" r="1" class="socialDot262"/></svg><span><b>Instagram</b><small>@beyondthevisa_official</small></span>
      </a>
