(function(){
  ...
  function applyAvatar(url){if($('#pfPhoto'))$('#pfPhoto').src=url;if($('#headerProfile img'))$('#headerProfile img').src=url;document.querySelectorAll('[data-btv-profile-photo],.btvMemberMenuHead82 img').forEach(image=>image.src=url);window.dispatchEvent(new CustomEvent('btv:profile-photo-updated',{detail:{url}}))}
