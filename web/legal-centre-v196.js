(() => {
  ...
  function install() {
    ...
    const backButton = legal.querySelector('[data-legal-back]');
    backButton.dataset.historyBack = '1';
    backButton.setAttribute('aria-label', 'Back to previous Beyond The Visa page');
